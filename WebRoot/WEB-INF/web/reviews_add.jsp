...
<form action="${pageContext.request.contextPath}/reviews_add.action" method="post" >
...
<h2>
内容
<span><input name="reviews.content" type="text" class="contact-input" />*</span>
</h2>

<h2>
等级
<span><input name="reviews.overall" type="text" class="contact-input" />*</span>
</h2>
