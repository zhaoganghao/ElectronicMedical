...
<div class="title-part-bg">Request an Appointment<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></div>
</div>
<!--Title Part End-->
...
<h5>
Patient First Name
<span><input name="" type="text" class="search-input" /></span>
</h5>
...
<h5>
Genter
<span><select name="" class="search-input2">
...
<span><input name="" type="text" class="search-input inputDate" id="inputDate" value="07/15/2013" /></span>
</h5>

<h6><a href="#"><img src="images/search-now.png" width="104" height="29" alt="" /></a></h6>
</div>
