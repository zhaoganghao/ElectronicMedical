...
<table width="649" border="1" align="center" cellpadding="3" cellspacing="0"  bordercolor="#E0E0E0" >
  <tbody>
    ...
    <td width="131" height="127" align="center"><p><img src="${pageContext.request.contextPath}${user.avatar}" width="100" height="100"></p>
      <p><s:property value="user.username"/></p></td>
    <td width="500">
    	<p>地址：<s:property value="user.address"/></p>
    	<p>电话：<s:property value="user.phone"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='<s:url action="process_appointUI" namespace="/"></s:url>?doctorid=${user.id}'><img src="images/web/appoint.png" width="103" height="29" alt="" /></a>   </p>
        <p>邮箱：<s:property value="user.email"/></p></td>
  </tr>
  <tr>
    <td align="center">
    ...
    <a href='<s:url action="register_secondUI" namespace="/"></s:url>?user.id=${user.id}'>选择角色</a>
	 ...
	 <s:if test="user.role == 'patient'">
    	病人
	</s:if>
	 <s:if test="user.role == 'doctor'">
    	医生
	</s:if>
    </td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><p><img src="${pageContext.request.contextPath}${user.identity.ic_image}" width="300" height="300"></p>
      <p>证件号：<s:property value="user.identity.NRIC_FIN"/>&nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;姓名：<s:property value="user.identity.name"/></p></td>
  </tr>
  <tr>
